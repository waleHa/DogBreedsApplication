...
data class DogBreedModel(
    ...
    val african: List<Any?>? = listOf(),
    @SerializedName("airedale")
    val airedale: List<Any?>? = listOf(),
    @SerializedName("akita")
    val akita: List<Any?>? = listOf(),
    @SerializedName("appenzeller")
    val appenzeller: List<Any?>? = listOf(),
    @SerializedName("australian")
    val australian: List<String?>? = listOf(),
    @SerializedName("basenji")
    val basenji: List<Any?>? = listOf(),
    @SerializedName("beagle")
    val beagle: List<Any?>? = listOf(),
    @SerializedName("bluetick")
    val bluetick: List<Any?>? = listOf(),
    @SerializedName("borzoi")
    val borzoi: List<Any?>? = listOf(),
    @SerializedName("bouvier")
    val bouvier: List<Any?>? = listOf(),
    @SerializedName("boxer")
    val boxer: List<Any?>? = listOf(),
    @SerializedName("brabancon")
    val brabancon: List<Any?>? = listOf(),
    @SerializedName("briard")
    val briard: List<Any?>? = listOf(),
    ...
    val rottweiler: List<Any?>? = listOf(),
    @SerializedName("saluki")
    val saluki: List<Any?>? = listOf(),
    @SerializedName("samoyed")
    val samoyed: List<Any?>? = listOf(),
    @SerializedName("schipperke")
    val schipperke: List<Any?>? = listOf(),
